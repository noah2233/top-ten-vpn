    ...
    childGroupPages: [
        {
            name: null,
            pages: [
                { name: 'Cyber Ghost', path: 'cyber-ghost', score: 9.9, offer: 'https://www.cyberghostvpn.com' },
                ...
                { name: 'Panda VPN', path: 'panda', score: 8.2, offer: 'https://www.pandasecurity.com' },
                ...
                { name: 'Avira Phantom VPN', path: 'avira-phantom-vpn', score: 6.9, offer: 'https://www.avira.com' },
                { name: 'Hotspot Shield', path: 'hotspotshield', score: 6.7, offer: 'https://www.gethotspotshield.com' },
                { name: 'ExpressVPN', path: 'expressvpn', score: 6.6, offer: 'https://www.expressvpn.com' },
                { name: 'McAfee Safe Connect', path: 'mcafee-safe-connect', score: 6.4, offer: 'https://www.mcafee.hsselite.com' },
                { name: 'SpyOFF', path: 'spyoff', score: 6.4, offer: 'https://www.shop.spyoff.com' },
                { name: 'AvastVPN', path: 'avast', score: 6.3, offer: 'https://www.avast.com' },
                {
                    name: 'Norton WiFi Privacy VPN', path: 'nortonwifiprivacy', score: 6.1,
                ...
                {
                    name: 'Private Internet Access', path: 'private-internet-access', score: 5.4,
                    offer: 'https://www.privateinternetaccess.com'
                },
                {
                    name: 'Invisible Browsing VPN', path: 'ibvpn', score: 5.3,
                    offer: 'https://www.ibvpn.com'
                },
                { name: 'GhostPath', path: 'ghostpath', score: 5.1, offer: 'https://www.ghostpath.com' },
                { name: 'VPN One Click', path: 'vpn-one-click', score: 5.0, offer: 'https://www.vpnoneclick.com' },
                ...
                { name: 'VPN4All', path: 'vpnforall', score: 5.0, offer: 'https://www.vpn4all.com' },
                ...
                { name: 'VPNJack', path: 'vpn-jack', score: 5.0, offer: 'https://www.vpnjack.com' },
                { name: 'VPN Tunnel', path: 'vpntunnel', score: 5.0, offer: 'https://www.vpntunnel.com' },
                { name: 'Juniper Networks', path: 'junipernetworks', score: 5.0, offer: 'https://www.juniper.net' },
                ...
                { name: 'My Private Network', path: 'my-private-network', score: 5.0, offer: 'https://www.my-private-network.co.uk' },
                { name: 'Boleh VPN', path: 'boleh-vpn', score: 5.0, offer: 'https://www.bolehvpn.net' },
                ...
                { name: 'SecureVPN', path: 'secure-vpn', score: 5.0, offer: 'https://www.securevpn.com' },
