...
export class SiteHeaderComponent implements OnInit {
  ...
  navItems: NavItem[] = [
    ...
    { name: pages.bestVpnFor.name, href: '/' + pages.bestVpnFor.href },
    { name: pages.vpnReviews.name, href: '/' + pages.vpnReviews.href },
    { name: pages.guides.name, href: '/' + pages.guides.href },
  ...
  isActive(navItem: NavItem) {
    return this._router.url.toLowerCase() === navItem.href.toLowerCase() ? true : false;
  }
}
